...
```{r, fig.cap= "Aantal banen CCS per gemeente Groot-Amsterdam, 2021 (abs.)", fig.width=4, fig.height=4}
# figuur rechts 
...
::: {style="display: grid; grid-template-columns: 1fr 1fr"}
```{r, fig.cap= "Aantal bedrijven en banen in deelsectoren CCS, 2021 (abs.)", fig.width=4, fig.height=3}
# figuur links 
plot_list$int_plot2
```
...
```{r, fig.width=4, fig.height=3, fig.cap= "Aandeel bedrijven en banen CCS per gemeente, 2021 (aandeel CCS van totaal aantal bedrijven en banen, %)"}
# figuur rechts 
plot_list$int_plot3
```
:::
...
```{r, fig.cap="Ontwikkeling bedrijven en banen CCS, 2017-2021 (indexcijfers, 2017=100)" }
plot_list$int_plot4
```
...
::: {style="display: grid; grid-template-columns: 1fr 1fr"}
```{r , fig.cap="Bedrijfsgrootte CCS en totale economie, 2021 (%)", fig.width=4, fig.height=3 }
plot_list$int_plot5
```
...
::: {style="display: grid; grid-template-columns: 1fr 1fr"}
```{r fig.cap=c("Verdeling werkenden naar mannen en vrouwen in CCS en totale economie, 2021 (%)", "Verdeling werkenden naar leeftijdsgroep in CCS en totale economie, 2021 (%)")}
...
::: {style="display: grid; grid-template-columns: 1fr 1fr"}
```{r fig.cap=c("Verdeling werkenden naar herkomstgroep in CCS en totale economie, 2021 (%)", "Verdeling werkenden naar opleidingsgroep in CCS en totale economie, 2021 (%)")}
...
```{r fig.cap="Mediaan bruto inkomen huishouden van kunstenaars en  werkenden in CSS en totale werkende beroepsbevolking, Groot-Amsterdam, 2021 (euro's)"}
...
in opdracht van\
Economische Zaken en Cultuur (EZC)\
Gemeente Amsterdam\
April 2023
